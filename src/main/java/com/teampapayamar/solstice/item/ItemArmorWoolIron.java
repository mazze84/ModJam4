...
public class ItemArmorWoolIron extends ItemArmorSolstice
{
    ...
    {
        super(Names.Armor.WOOL_LINED_IRON_ARMOR, ArmorMaterialWoolLinedIron, armorType);
    }
    ...
    public String getArmorTexture(ItemStack armorStack, Entity entity, int armorSlot, String type)
    {
        if (armorStack.getItem() instanceof ItemArmorSolstice)
        {
            ...
            {
                return Textures.WOOL_LINED_IRON_ARMOR_LAYER1;
            }
            else if (armorSlot == ArmorType.LEGS.ordinal())
            {
                return Textures.WOOL_LINED_IRON_ARMOR_LAYER2;
            }
        }
