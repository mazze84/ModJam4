...
public class Textures
{
    ...
    public static final String GUI_RESOURCE_LOCATION = RESOURCE_PREFIX + "textures/gui/";
    public static final String MODEL_RESOURCE_LOCATION = "textures/models/";
    public static final String ARMOR_RESOURCE_LOCATION = MODEL_RESOURCE_LOCATION + "armor/";
